        ...
        <div className="product-preview">
          <div className="preview-card">
            <div className="preview-images">
              {formData.images.length > 0 ? (
                <div className="image-gallery">
                  <img src={formData.images[0].url || "/placeholder.svg"} alt="Main product" className="main-image" />
                  {formData.images.length > 1 && (
                    <div className="thumbnail-list">
                      ...
                      {formData.images.length > 4 && <div className="more-images">+{formData.images.length - 4}</div>}
                    </div>
                  )}
                </div>
              ) : (
            ...
            <div className="preview-info">
              <h2 className="product-title">{formData.name || "Tên sản phẩm"}</h2>
              <p className="product-sku">SKU: {formData.sku || "Chưa có mã SKU"}</p>

              <div className="product-price">
                <span className="price">
                  ₫{formData.price ? Number.parseInt(formData.price).toLocaleString() : "0"}
                </span>
                <span className={`stock ${Number.parseInt(formData.quantity) > 0 ? "in-stock" : "out-of-stock"}`}>
              ...
              <div className="product-details">
                ...
                <div className="detail-row">
                  ...
                  <span className="value">{formData.supplier || "Chưa chọn"}</span>
                </div>
                {formData.weight && (
                  <div className="detail-row">
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <input
                  ...
                  disabled
                />
                <small className="form-help">Mã SKU không thể thay đổi sau khi tạo</small>
              ...
              <div className="uploaded-images">
                {formData.images.map((image) => (
                  <div key={image.id} className="image-item">
                    ...
                    {image.isExisting && <div className="existing-badge">Hiện tại</div>}
